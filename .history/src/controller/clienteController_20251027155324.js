...
const clienteController = {
    ...
    adicionarCliente: async (req, res) => {
        ...
        try {
            ...
            const cpfEmUso = await clienteModel.validacaoCpf());
            if (validacaoCpf.length === 0) {
                throw new Error('Este CPF já está sendo usado por um cliente');
            }
            ...
            console.error(error);
            res.status(409).json({ message: 'Ocorreu um erro no servidor :( ', errorMessage: error.message });
        }
